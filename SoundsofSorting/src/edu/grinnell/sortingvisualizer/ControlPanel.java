...
public class ControlPanel extends JPanel {
	...
	private static List<SortEvent<Integer>> generateEvents(String sort, Integer[] arr) {
		...
		case "Merge":
			return Sorts.mergeSort(arr,0,end);
		case("Quick"):
			return Sorts.quickSort(arr,0,end);
		default:
	...
	public ControlPanel( final NoteIndices notes,  final ArrayPanel panel) {
		...
		playButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Integer[] temp = notes.getNotes().clone();
				final List<SortEvent<Integer>> events =  generateEvents((String) sorts.getSelectedItem(),temp);
				for (int i =0;i<temp.length-1;i++){
					CompareEvent<Integer> com = new CompareEvent<Integer>(i,i + 1);
					events.add(com);
				}
